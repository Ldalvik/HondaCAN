...
/* 
    ...
    for the OBD commands, which may be faster but could be "bus spam" and slow down/reject 
...
private:
    ...
    // inline const char (*get_dtc_list(uint8_t &count))[6]{} // can't work on until next maintenance code pops up lol
};
